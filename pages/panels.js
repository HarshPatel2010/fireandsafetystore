        ...
        {Object.keys(products).map((item)=>{
          ...
          <div className="lg:w-1/5 md:w-1/2 p-4 w-full cursor-pointer shadow-lg m-5">
            ...
            <div className="mt-4  text-center md:text-left">
              <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">Panels</h3>
...
export async function getServerSideProps(context) {
  ...
  let products = await Product.find({category:"panel"});
  let panel = {};
  ...
  return {
    props: {products:JSON.parse(JSON.stringify(panel))}, // will be passed to the page component as props
  }
}
