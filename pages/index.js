...
export default function Home() {
  ...
  return (
    ...
    <div className='w-full'>
      <Head>
        <title>Fire and Safety Store</title>
        <meta name="description" content="fireandsafetystore.com -we look for your safety" />
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">we look for your safety -Fireandsafetystore.com</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Buy whatever you want? what you want for you safety? you want equiptments for your safety?so why not but from Fire and safety store?</p>
    </div>
